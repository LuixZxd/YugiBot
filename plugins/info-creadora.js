...
𝙰 𝙲𝙾𝙽𝚃𝙸𝙽𝚄𝙰𝙲𝙸𝙾𝙽 𝚂𝙴 𝙴𝙽𝚅𝙸𝙰𝚁𝙰 𝙴𝙻 𝙲𝙾𝙽𝚃𝙰𝙲𝚃𝙾 𝙳𝙴 LOS CREADORES DE 
...
description = official[0][0] == String(contact[0]) ? '*_𝙶𝙾𝙺𝚄_𝙱𝙾𝚃 - 𝙼𝙳_*' : official[1][0] == String(contact[0]) ? '*_𝙶𝙾𝙺𝚄_𝙱𝙾𝚃 - 𝙼𝙳_*' : official[2][0] == String(contact[0]) ? '*_𝙶𝙾𝙺𝚄_𝙱𝙾𝚃 - 𝙼𝙳_*' : official[3][0] == String(contact[0]) ? '*_𝙶𝙾𝙺𝚄_𝙱𝙾𝚃 - 𝙼𝙳_*' : desc === '' ? 'FantasyBot-MD' : desc
correo = official[0][0] == String(contact[0]) ? '*_𝙶𝙾𝙺𝚄_𝙱𝙾𝚃 - 𝙼𝙳_*' : official[1][0] == String(contact[0]) ? '*_𝙶𝙾𝙺𝚄_𝙱𝙾𝚃 - 𝙼𝙳_*' : official[2][0] == String(contact[0]) ? '*_𝙶𝙾𝙺𝚄_𝙱𝙾𝚃 - 𝙼𝙳_*' : mail === '' ? lenguajeGB.smsContacto6() : mail
...
enlace = official[0][0] == String(contact[0]) ? '*_𝙶𝙾𝙺𝚄_𝙱𝙾𝚃 - 𝙼𝙳_*' : official[1][0] == String(contact[0]) ? '*_𝙶𝙾𝙺𝚄_𝙱𝙾𝚃 - 𝙼𝙳_*' : official[2][0] == String(contact[0]) ? '*_𝙶𝙾𝙺𝚄_𝙱𝙾𝚃 - 𝙼𝙳_*' : official[3][0] == String(contact[0]) ? '*_𝙶𝙾𝙺𝚄_𝙱𝙾𝚃 - 𝙼𝙳_*' : md 
   
lista.push([number, ofc, nombre, description, official[3][0] == String(contact[0]) ? null : correo, lugar, enlace, bio, official[1][0] == String(contact[0]) ? '*_𝙶𝙾𝙺𝚄_𝙱𝙾𝚃 - 𝙼𝙳_*' : null]) }  
lista.push([conn.user.jid.split('@')[0], await conn.getName(conn.user.jid), fantasy, lenguajeGB.smsContacto8(), mail === '' ? '*_𝙶𝙾𝙺𝚄_𝙱𝙾𝚃 - 𝙼𝙳_*' : mail, lenguajeGB.smsContacto7(), md, bioBot, yt, ig, fb, paypal, nna])
