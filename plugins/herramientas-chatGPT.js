...
let sistema1 = `Actuaras como un Bot de WhatsApp el cual fue creado por Aldair , tu seras *_GOKU_BOT_*`;
...
try {
const syms1 = `Actuaras como un Bot de WhatsApp el cual fue creado por Aldair, tu seras *_GOKU_BOT_*`;
